<template>
    ...
    <newMajorDialog ref="NewDialog" @relodData="queryAll"></newMajorDialog>
</template>

<script>
import newMajorDialog from './newMajorDialog.vue'
...
export default {
    ...
    methods: {
        queryAll(){
            majorRequest.queryAll().then((reponse)=>{
        ...
        handleEdit(index,row){
            this.$refs.NewDialog.major.id=row.id;
        ...
        handleDelete(index,row){
            ElMessageBox.confirm(
                ...
                majorRequest.deleteData(row.id).then(response=>{
